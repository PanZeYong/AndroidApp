...
public class CustomRecycleViewAdapter extends RecyclerView.Adapter implements IWrapperAdapter {
    ...
    public CustomRecycleViewAdapter(ArrayList<View> mHeaderViews, ArrayList<View> mFootViews, RecyclerView.Adapter mAdapter) {
